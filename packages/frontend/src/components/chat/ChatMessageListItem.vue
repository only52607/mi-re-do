<template>
    <div v-if="event.type=='SentMessage'" id="item" style="flex-direction: row-reverse;">
        ...
        <div id="bubble-and-name" style="text-align: right;">
            ...
            <chat-message-bubble-send @display-image="emitDisplayImage" :content="event.messageChain"> </chat-message-bubble-send>
        </div>
    </div>
    <div v-else id="item">
        <template v-if="event.type=='FriendMessage'">
            ...
            <div id="bubble-and-name">
                ...
                <chat-message-bubble-receive @display-image="emitDisplayImage" :content="event.messageChain"> </chat-message-bubble-receive>
            </div>
        </template>
