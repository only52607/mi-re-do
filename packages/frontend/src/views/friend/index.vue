<template>
  <a-row style="height:100%;">
    ...
    <a-col :span="16" style="height:100%; overflow:auto;">
      <friend-details
        @goto-friend-session="gotoFriendSession"
        :friend="selectedFriend"
        :loading="profileState != 'done'"
        :profile="profile"
...
import { pushEmptySession, sessionIdentityAsString } from "@/use/session";
